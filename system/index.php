...
<body>
    ...
    <footer class="bg-white shadow pt-3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 text-center mb-3">
                        ...
                        <center>
                            <div class="mb-3 fb-page" data-href="<?php echo $config['facebook']; ?>" data-tabs="timeline" data-width="320" data-height="70" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="<?php echo $config['facebook']; ?>" class="fb-xfbml-parse-ignore"><a href="<?php echo $config['facebook']; ?>">Facebook</a></blockquote></div>
                            <br>
        ...
        <center>
            ...
            <small class="text-dark "></i><i class="fa-solid fa-cog fa-spin"></i>&nbsp; Create By SongKran & Sxdd.<a href="<?php echo $config['discord']; ?>" class="text-dark"> ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
        </center>
    </div>
    <script>
