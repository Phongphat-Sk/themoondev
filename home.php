...
<body>
    ...
    <center>
        <p class="text-white mb-1 "><strong><i class="fa-regular fa-copyright"></i>&nbsp; 2024 <?php echo $config['name']; ?>, All right reserved.</strong></p>
        <small class="text-white mb-1 "></i>&nbsp; THEMOON  DEV <a href="<?php echo $config['facebook']; ?>" class="text-white mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
    </center>
