...
<div class="card-body">
<div class="text-center aos-init aos-animate">
<a href="<?php echo $config['facebook']; ?>" style="text-decoration: none;" data-aos="zoom-in" data-aos-duration="1000" class="aos-init aos-animate">
                            <div class="align-self-center pt-3 pb-1 ">
                                <center>
     ...
     <!-- <div class="container-sm p-4" data-aos="fade-down">
      ...
      <!-- <div class="container-fluid bg-white shadow-sm p-3  " style="border-radius: 1hv;">
            <div class="d-flex justify-content-between">
                <span class="h4 text-main "> <img src="assets/icon/application.png" class="m-0 mb-2" style="height: 2.5rem;">&nbsp;<b>หมวดสำหรับคุณ</b></span>
