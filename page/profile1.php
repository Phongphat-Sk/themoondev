            ...
            <div class="col-lg-12 ">
                <div class="container-fluid shadow-sm bg-white pt-4 pb-4 ps-4 rounded mb-2" style="border-radius: 50px;">
                    <div class="row">
                        <div class="col-lg-5">
                            <!-- นำรูปภาพมาแสดง โดยใช้ CSS เพื่อทำให้เป็นวงกลมและขนาด 100x100 -->
                            <img src="<?php echo htmlspecialchars($user["imglogo"]); ?>" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
                        </div>
                        <div class="col-lg-3">
