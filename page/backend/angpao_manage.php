<div class="container-sm bg-glass mt-5 border-2 shadow-sm p-4 mb-4 rounded" data-aos="fade-down">
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-browser"></i>&nbsp;จัดการเติมเงินวอเลท</h1>
    </center>
    <hr>
    <div class="col-lg-6 m-auto">
        <div class="mb-2 ">
            <p class="m-0 text-dark ">เบอร์รับเงิน (TrueWallet) <span class="text-danger">*</span></p>
            <input type="text" id="site_wallet" class="form-control" value="<?php echo $config['wallet']; ?>">
        </div>
        <div class="mb-2">
            <p class="m-0 text-dark ">เก็บ 2.3% ไม่เกิน 10 บาท<span class="text-danger">*</span></p>
