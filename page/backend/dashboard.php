 ...
 <div class="container-sm bg-white mt-5 mb-5 border  border-2 shadow-sm p-4 " style="border-radius: 25px;">
    <h1 class="text-main"><i class="fa-duotone fa-gears"></i>&nbsp;ระบบจัดการหลังร้าน</h1>
    <div class="row justify-content-start">
        ...
        <div class="col-lg-3 mb-3">
            <a href="?page=carousel_manage" class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-duotone fa-browser"></i></h1>
                <h4 class="text-main">จัดการภาพสไลด์</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
        ...
        <div class="col-lg-3 mb-3">
            <a href="?page=category_manage"class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-light fa-boxes-stacked"></i></h1>
                <h4 class="text-main">จัดการหมวดหมู่</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
        ...
        <div class="col-lg-3 mb-3">
            <a href="?page=wheel_cate"class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-light fa-boxes-stacked"></i></h1>
        ...
        <div  class="col-lg-3 mb-3">
            <a  href="?page=angpao_manage" class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-duotone fa-coins"></i></h1>
                <h4 class="text-main">จัดการเติมเงินวอเลท</h4>
            </a>
        </div>
        </div>
    </div>
