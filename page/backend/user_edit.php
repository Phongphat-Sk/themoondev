            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-darke"><?php echo htmlspecialchars($row['total']); ?></td>
                        <td class="text-dark"><button class="btn btn-warning text-dark w-50" onclick="get_detail(<?php echo $row['id']; ?>)"><i class="fa-solid fa-pencil"></i>&nbsp;แก้ไข</button></td>
                        <td class="text-dark"><button class="btn btn-danger text-white w-50" onclick="del('<?php echo $row['id']; ?>','<?php echo htmlspecialchars($row['username']); ?>')"><i class="fa-solid fa-trash"></i> ลบ</button></td>
                    </tr>
                <?php
                }
                ?>
