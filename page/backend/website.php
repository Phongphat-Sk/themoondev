...
<div class="container-sm bg-glass mt-5 border-2 shadow-sm p-4 mb-4 rounded" data-aos="fade-down">
    ...
    <div class="col-lg-6 m-auto">
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark ">ชื่อเว็บไซต์ <span class="text-danger">*</span></p>
            <input type="text" id="site_name" class="form-control" value="<?php echo $config['name']; ?>">
        </div>
        <div class="mb-2 ">
            <p class="m-0 text-dark ">ภาพ Logo (ลิงค์) <span class="text-danger">*</span></p>
            <input type="text" id="site_logo" class="form-control" value="<?php echo $config['logo']; ?>">
        </div>

        <div class="mb-2 ">
            <p class="m-0 text-dark ">ภาพ Background (ลิงค์) <span class="text-danger">*</span></p>
            <input type="text" id="site_bg" class="form-control" value="<?php echo $config['bg2']; ?>">
        </div>

        <div class="mb-2 ">
            <p class="m-0 text-dark ">ภาพ Widget Discord (ลิงค์) <span class="text-danger">*</span></p>
            <input type="text" id="site_bg" class="form-control" value="<?php echo $config['bg3']; ?>">
        </div>

        <div class="mb-2">
            <p class="m-0 text-dark ">ประกาศ <span class="text-danger">*</span></p>
            <input type="text" id="ann" class="form-control" value="<?php echo $config['ann']; ?>">
        </div>

        <div class="mb-2 ">
            <p class="m-0 text-dark ">คำอธิบายร้านค้า <span class="text-danger">*รวมถึงEmbed</span></p>
        ...
        <div class="row justify-content-between">
            <div class="mb-5 col">
                <div class="text-center">
                    <p class="m-0 text-dark">สีหลักของเว็บไซต์ <span class="text-danger">*</span></p>
                    <input type="color" class="form-control form-control-color w-100" id="site_main_color" value="<?php echo $config['main_color']; ?>">
                </div>
            </div>
            <div class="mb-5 col">
                <div class="text-center">
                    <p class="m-0 text-dark">สีรองของเว็บไซต์ <span class="text-danger">*</span></p>
        ...
        <div class="mb-2">
            <p class="m-0 text-dark ">Widget Discord (ไอดี) <span class="text-danger">*</span></p>
            <input type="text" id="site_widget_discord" class="form-control" value="<?php echo $config['widget_discord']; ?>">
        </div>

        <div class="mb-2 ">
            <p class="m-0 text-dark ">Webhook Discord (ลิงค์) <span class="text-danger">*สำหรับแจ้งเตือน ซื้อของ/เติมเงิน</span></p>
            <input type="text" id="webhook_dc" class="form-control" value="<?php echo $config['webhook_dc']; ?>">
        </div>

        <div class="mb-2">
            <p class="m-0 text-dark ">ช่องทางการติดต่อ Discord (ลิงค์) <span class="text-danger">*</span></p>
            <input type="text" id="site_contact_discord" class="form-control" value="<?php echo $config['discord']; ?>">
        </div>
        <div class="mb-2">
            <p class="m-0 text-dark ">ช่องทางการติดต่อ Facebook (ลิงค์) <span class="text-danger">*</span></p>
