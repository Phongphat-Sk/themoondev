    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mx-auto">
            <li class="nav-item active">
                <a class="nav-link text-dark" href="?page=backend">แดชบอร์ด</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" href="?page=website">จัดการเว็บไซต์</a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="?page=carousel_manage">จัดการรูปภาพสไลด์</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" href="?page=user_edit">จัดการผู้ใช้</a>
            </li>
            <li class="nav-item dropdown" style="list-style: none;">
                <a class="nav-link text-dark" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                จัดการร้านค้า
