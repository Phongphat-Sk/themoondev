    ...
    <div class="row jusify-content-between mt-4">
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-black"><?php echo $month["total"];?>฿</h1>
        ...
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-black"><?php echo $day["total"];?>฿</h1>
        ...
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-black"><?php echo $topup["total"];?>฿</h1>
        ...
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-black"><?php echo $box_month;?></h1>
        ...
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-black"><?php echo $box_day;?></h1>
        ...
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-black"><?php echo $box_all;?></h1>
